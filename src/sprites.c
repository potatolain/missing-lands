...
const unsigned char sprite_data[] = {
	// World
	SPRITE_TYPE_WORLD_PIECE, SPRITE_SIZE_NORMAL | SPRITE_PALETTE_1 | SPRITE_ANIM_DEFAULT, 0x08, LEVEL_FRAGMENT_1,
	SPRITE_TYPE_WORLD_PIECE, SPRITE_SIZE_NORMAL | SPRITE_PALETTE_1 | SPRITE_ANIM_DEFAULT, 0x08, LEVEL_FRAGMENT_2,
	// Turtle
