...
ROM_NAME=world
OBJECTS_TO_BUILD=$(ROM_NAME).c levels/processed/lvl1_tiles.asm bin/build_info.h bin/crt0.o bin/$(ROM_NAME).o bin/title.o bin/level_manip.o bin/movement.o bin/sprites.o
