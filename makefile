...
ROM_NAME=world
OBJECTS_TO_BUILD=$(ROM_NAME).c levels/processed/lvl1_tiles.asm levels/processed/lvl2_tiles.asm levels/processed/lvl3_tiles.asm levels/processed/lvl4_tiles.asm levels/processed/lvl5_tiles.asm bin/build_info.h bin/crt0.o bin/$(ROM_NAME).o bin/title.o bin/level_manip.o bin/movement.o bin/sprites.o
